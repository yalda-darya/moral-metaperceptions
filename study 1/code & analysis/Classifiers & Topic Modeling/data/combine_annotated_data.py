...
for file_name in os.listdir("./raw/abortion_sentiment_prediction/abortion1_csv_files"):
    if file_name.endswith(".csv"):
        # read the csv file into a dataframe
        file_path = os.path.join("./raw/abortion_sentiment_prediction/abortion1_csv_files", file_name)
...
combined_data.to_csv("./raw/abortion_sentiment_prediction/wave1_annotated.csv", index=False)
